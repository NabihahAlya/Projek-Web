 ...
 const roomImages = {
    'deluxe': [
        ...
        "assets/img/deluxe room.jpeg",
        "assets/img/Deluxe.jpg",
        "assets/img/deluxe room.jpg"
    ],
    'executive': [
        "assets/img/executive room.jpg",
        "assets/img/executive room (1).jpg",
        "assets/img/executive room (2).jpg",
        "assets/img/executive room (3).jpg"
    ],
    'family': [
        "assets/img/family room.jpg",
        "assets/img/family room (1).jpg",
        "assets/img/family room (2).jpg",
        "assets/img/family room.jpg"
    ]
};
...
function changeImage(roomType, imageIndex) {
    // Update main image
    document.getElementById(`${roomType}-main-image`).src = roomImages[roomType][imageIndex];
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    for (const roomType in roomImages) {
        ...
        document.getElementById(`${roomType}-main-image`).src = roomImages[roomType][0];
