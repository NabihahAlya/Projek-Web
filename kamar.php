...
<div class="container mb-5">
    ...
    <div id="deluxe-room" class="room-container active">
        <div class="row">
            <div class="col-lg-7">
                <!-- Main Image -->
                <img src="assets/img/deluxe room.jpg" alt="Deluxe Room" class="main-image" id="deluxe-main-image">
                
                <!-- Thumbnails -->
                <div class="thumbnail-container">
                    <img src="assets/img/deluxe room.jpg" alt="Deluxe Room 1" class="thumbnail active" onclick="changeImage('deluxe', 0)">
                    <img src="assets/img/deluxe room.jpeg'" alt="Deluxe Room 2" class="thumbnail" onclick="changeImage('deluxe', 1)">
                    <img src="assets/img/Deluxe.jpg" alt="Deluxe Room 3" class="thumbnail" onclick="changeImage('deluxe', 2)">
                    <img src="'assets/img/deluxe room.jpg" alt="Deluxe Room 4" class="thumbnail" onclick="changeImage('deluxe', 3)">
                </div>
            </div>
