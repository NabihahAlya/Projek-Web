...
<html lang="en">
  ...
  <body>
    <div class="wrap">
    <div class="slideshow-background" data-images='["<?= base_url('assets/img/fotopage4-1.jpg') ?>", "<?= base_url('assets/img/fotopage4-2.jpg') ?>", "<?= base_url('assets/img/fotopage4-3.jpg') ?>"]'></div>
    <div class="form">
      <h2>Kritik & Saran</h2>
