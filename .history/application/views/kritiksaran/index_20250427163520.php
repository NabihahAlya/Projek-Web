...
<html lang="en">
  ...
  <body>
    ...
    <div class="form">
      ...
      <?php if ($this->session->flashdata('message') && $this->input->server('REQUEST_METHOD') === 'POST'): 
?>
            <div class="alert" style="padding: 10px; background-color: #4CAF50; color: white; margin-bottom: 15px; border-radius: 5px; text-align: center;">
                <?= $this->session->flashdata('message'); ?>
            </div>
            <?php $this->session->unset_flashdata('message'); ?>
      <?php endif; ?>
