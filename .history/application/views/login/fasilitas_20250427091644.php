...
<div class="modal fade" id="modalFasilitas" tabindex="-1" aria-labelledby="modalFasilitasLabel" aria-hidden="true">
  ...
  <select id="ikon" class="form-select" name="ikon">
    ...
    <option value="fa-map-marker-alt" ></option>
    <option value="fa-bed" ></option>
    <option value="fa-utensils" ></option>
    <option value="fa-dumbbell"></option>
    <option value="fa-parking"></option>
    <option value="fa-swimmer"></option>
    <option value="fa-spa"></option>
    <option value="fa-tshirt"></option>
    <option value="fa-motorcycle"></option>
    <option value="fa-warehouse"></option>
    <option value="fa-map-signs"></option>
    <option value="fa-star"></option>
    <option value="fa-star-half-alt"></option>
  </select>
</div>
