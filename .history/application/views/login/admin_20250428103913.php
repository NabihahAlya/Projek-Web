          ...
          <table class="table table-hover">
            ...
            <?php  $id = 1;  foreach ($admin_list as $a) : ?>
              <tr>
                ...
                <td>
                  <a href="#" class="btn btn-sm btn-warning btn-edit-admin"  data-bs-toggle="modal" data-bs-target="#modalEditAdmin">Edit</a>
...
<div class="modal fade" id="modalEditAdmin" tabindex="-1" aria-labelledby="modalEditAdminLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="<?= base_url('admin/update_admin/' . $a->id) ?>" method="post" enctype="multipart/form-data">
