...
<div class="modal fade" id="modalFasilitas" tabindex="-1" aria-labelledby="modalFasilitasLabel" aria-hidden="true">
  ...
  <select id="ikon" class="form-select" name="ikon">
    ...
    <option value="fa-map-marker-alt" data-icon="fa-map-marker-alt"></option>
    <option value="fa-bed" data-icon="fa-bed"></option>
    <option value="fa-utensils" data-icon="fa-utensils"></option>
    <option value="fa-dumbbell" data-icon="fa-dumbbell"></option>
    <option value="fa-parking" data-icon="fa-parking"></option>
    <option value="fa-swimmer" data-icon="fa-swimmer"></option>
    <option value="fa-spa" data-icon="fa-spa"></option>
    <option value="fa-tshirt" data-icon="fa-tshirt"></option>
    <option value="fa-motorcycle" data-icon="fa-motorcycle"></option>
    <option value="fa-warehouse" data-icon="fa-warehouse"></option>
    <option value="fa-map-signs" data-icon="fa-map-signs"></option>
    <option value="fa-star" data-icon="fa-star"></option>
    <option value="fa-star-half-alt" data-icon="fa-star-half-alt"></option>
  </select>
</div>
