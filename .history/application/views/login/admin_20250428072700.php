          ...
          <table class="table table-hover">
            ...
            <?php  $id = 1;  foreach ($admin_list as $a) : ?>
              <tr>
                ...
                <td>
                  <a href="#" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#modalAdmin">+ Edit</a>
                  <a href="<?= base_url('admin/hapus_admin/' . $f->id_admin) ?>" class="btn btn-sm btn-danger">Hapus</a>
                </td>
              </tr> 
            <?php endforeach; ?>
            </tbody>
...
<!-- Modal Edit Admin -->
<div class="modal fade" id="modalAdmin" tabindex="-1" aria-labelledby="modalEditAdminLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="<?= base_url('admin/edit_admin'); ?>" method="post" enctype="multipart/form-data">
        <div class="modal-header">
          <h5 class="modal-title" id="modalAdminLabel">Edit Admin</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
