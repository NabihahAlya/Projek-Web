...
<div class="modal fade" id="modalFasilitas" tabindex="-1" aria-labelledby="modalFasilitasLabel" aria-hidden="true">
  ...
  <select id="ikon" class="form-select" name="ikon" onchange="previewIcon(this)">
      ...
      <option value="fa-map-marker-alt" data-icon="fa-map-marker-alt">Lokasi</option>
      <option value="fa-bed" data-icon="fa-bed">Kamar Tidur</option>
      <option value="fa-utensils" data-icon="fa-utensils">Restoran</option>
      <option value="fa-dumbbell" data-icon="fa-dumbbell">Gym</option>
      <option value="fa-parking" data-icon="fa-parking">Parkir</option>
      <option value="fa-swimmer" data-icon="fa-swimmer">Kolam Renang</option>
      <option value="fa-spa" data-icon="fa-spa">Spa</option>
      <option value="fa-tshirt" data-icon="fa-tshirt">Laundry</option>
      <option value="fa-motorcycle" data-icon="fa-motorcycle">Sewa Motor</option>
      <option value="fa-warehouse" data-icon="fa-warehouse">Gudang</option>
      <option value="fa-map-signs" data-icon="fa-map-signs">Peta</option>
      <option value="fa-star" data-icon="fa-star">Bintang Hotel</option>
