...
<html lang="en">
  ...
  <body>
    ...
    <!-- Smooth scroll -->
    <script src="<?= base_url('include/vendor/onscreen/dist/on-screen.umd.min.js') ?>../../vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js"></script>

    <!-- Charts -->
    <script src="<?= base_url('include/vendor/onscreen/dist/on-screen.umd.min.js') ?>../../vendor/chartist/dist/chartist.min.js"></script>
