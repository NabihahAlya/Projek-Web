...
<div class="modal fade" id="modalFasilitas" tabindex="-1" aria-labelledby="modalFasilitasLabel" aria-hidden="true">
  ...
  <option value=""></option>
  <option value="fa-map-marker-alt" data-icon="&#xf3c5;"> Lokasi</option>
    <option value="fa-bed" data-icon="&#xf236;"> Kamar Tidur</option>
    <option value="fa-utensils" data-icon="&#xf2e7;"> Restoran</option>
    <option value="fa-dumbbell" data-icon="&#xf44b;"> Gym</option>
    <option value="fa-parking" data-icon="&#xf540;"> Parkir</option>
    <option value="fa-swimming-pool" data-icon="&#xf5c5;"> Kolam Renang</option>
    <option value="fa-spa" data-icon="&#xf5bb;"> Spa</option>
    <option value="fa-tshirt" data-icon="&#xf553;"> Laundry</option>
    <option value="fa-motorcycle" data-icon="&#xf21c;"> Sewa Motor</option>
    <option value="fa-warehouse" data-icon="&#xf494;"> Gudang</option>
    <option value="fa-map" data-icon="&#xf279;"> Peta</option>
    <option value="fa-star" data-icon="&#xf005;"> Bintang Hotel</option>
    <option value="fa-star-half-alt" data-icon="&#xf5c0;"> Bintang Setengah</option>
</select>
</div>
...
$(document).ready(function() {
  ...
  function formatIcon(option) {
    ...
    var $icon = $('<span><i class="fas ' + option.element.value + '"></i> ' + option.text + '</span>');
    return $icon;
  }
});
</script>
