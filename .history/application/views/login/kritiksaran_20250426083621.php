  ...
  <main class="content mt-5">
        ...
        <div class="card mt-5">
          ...
          <div class="card-body">
            <table class="table table-hover">
              ...
              <tbody id="kritik-table-body">
                <!-- Data akan dimuat lewat AJAX -->
                <?php $id = 1; foreach ($data as $k) : ?>
                <tr>
                  <td><?= $id++ ?></td>
    ...
    <script>
        ...
        function loadKritik() {
            ...
            xhr.open('GET', '<?= base_url('admin/load_kritik') ?>', true); // URL controller untuk load data

            xhr.onload = function() {
                if (xhr.status >= 200 && xhr.status < 300) {
                    // Jika berhasil, kita perbarui tabel dengan data yang diterima
                    document.getElementById('kritik-table-body').innerHTML = xhr.responseText;
                } else {
