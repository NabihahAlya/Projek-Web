          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="#" class="btn btn-sm btn-warning btn-edit-fasilitas" data-id="<?= $l->id_fasilitas ?>" data-bs-toggle="modal" data-bs-target="#modalEditFasilitas">Edit</a>
                  <a href="<?= base_url('admin/hapus_fasilitas/' . $l->id_fasilitas) ?>" class="btn btn-sm btn-danger">Hapus</a>
                </td>
              </tr>
              <?php endforeach; ?>
            </tbody>
