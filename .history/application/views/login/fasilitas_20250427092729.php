...
<div class="modal fade" id="modalFasilitas" tabindex="-1" aria-labelledby="modalFasilitasLabel" aria-hidden="true">
  ...
  <select id="ikon" class="form-select" name="ikon">
    ...
    <option value="fa-map-marker-alt" ><i class="fas fa-map-marker-alt "></i></option>
    <option value="fa-bed" ><i class="fas <?php echo $ikon; ?>"></i>
    </option>
    <option value="fa-utensils" ><i class="fas <?php echo $ikon; ?>"></i>
    </option>
    <option value="fa-dumbbell"><i class="fas <?php echo $ikon; ?>"></i>
    </option>
    <option value="fa-parking"><i class="fas <?php echo $ikon; ?>"></i>
    </option>
    <option value="fa-swimmer"><i class="fas <?php echo $ikon; ?>"></i>
    </option>
    <option value="fa-spa"><i class="fas <?php echo $ikon; ?>"></i>
    </option>
    <option value="fa-tshirt"><i class="fas <?php echo $ikon; ?>"></i>
    </option>
    <option value="fa-motorcycle"><i class="fas <?php echo $ikon; ?>"></i>
    </option>
    <option value="fa-warehouse"><i class="fas <?php echo $ikon; ?>"></i>
    </option>
    <option value="fa-map-signs"><i class="fas <?php echo $ikon; ?>"></i>
    </option>
    <option value="fa-star"><i class="fas <?php echo $ikon; ?>"></i>
    </option>
    <option value="fa-star-half-alt"><i class="fas <?php echo $ikon; ?>"></i>
    </option>
  </select>
</div>
