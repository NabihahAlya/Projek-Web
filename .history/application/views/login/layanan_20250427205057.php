      ...
      <div class="card mt-5">
        ...
        <div class="card-body">
          <table class="table table-hover">
            ...
            <tbody>
              <?php $no = 1; foreach ($layanan_list as $l) : ?>
              <tr>
                <td><?= $no++ ?></td>
                <td><?= $l->nama ?></td>
                <td><?= $l->tipe_aksi ?></td>
                <td><i class="fas <?= $l->ikon ?>"></i></td>
                <td>
                  <a href="#" class="btn btn-sm btn-warning btn-edit-Layanan" data-id="<?= $l->id_Layanan ?>" data-bs-toggle="modal" data-bs-target="#modalEditLayanan">Edit</a>
                  <a href="<?= base_url('admin/hapus_Layanan/' . $l->id_Layanan) ?>" class="btn btn-sm btn-danger">Hapus</a>
                </td>
              </tr>
              <?php endforeach; ?>
            </tbody>
    ...
    <div class="modal-content">
      <form action="<?= base_url('admin/tambah_Layanan'); ?>" method="post" enctype="multipart/form-data">
        <div class="modal-header">
          <h5 class="modal-title" id="modalLayanansLabel">Tambah Layanan</h5>
