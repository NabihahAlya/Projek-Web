          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>SPA & Massage</td>
                <td>Relaksasi total untuk tubuh dan pikiran.</td>
                <td>
                  <a href="#" class="btn btn-sm btn-warning">Edit</a>
                  <a href="#" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus layanan ini?')">Hapus</a>
                </td>
              </tr>
              <tr>
                <td>2</td>
                <td>Swimming Pool</td>
                <td>Kolam renang besar untuk berenang dan bermain air.</td>
                <td>
                  <a href="#" class="btn btn-sm btn-warning">Edit</a>
                  <a href="#" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus layanan ini?')">Hapus</a>
                </td>
