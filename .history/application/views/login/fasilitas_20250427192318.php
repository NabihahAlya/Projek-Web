...
$(document).ready(function() {
  ...
  // ======================== TAMBAH FILE DI TAMBAH FASILITAS ========================
  ...
  // ======================== UBAH TIPE AKSI DI TAMBAH FASILITAS ========================
  $('#tipeAksi').on('change', function() {
    const value = $(this).val();
    if (value === 'link') {
      $('#formLink').removeClass('d-none');
      $('#formPopup').addClass('d-none');
    } else if (value === 'popup') {
    ...
    $.ajax({
      ...
      success: function(data) {
        if (data) {
          ...
          $('#edit_formLink, #edit_formPopup').hide(); // Tutup semua dulu
          ...
          if (data.tipe_aksi === 'link') {
            ...
            if (data.fotos) {
              data.fotos.forEach(function(foto) {
                photosHtml += `<img src="<?= base_url('uploads/fasilitas/') ?>${foto}" class="img-thumbnail" width="100" style="margin: 4px;">`;
              });
            }
  ...
  // ======================== UBAH TIPE AKSI MANUAL DI MODAL EDIT ========================
  $('#edit_tipe_aksi').on('change', function() {
    const value = $(this).val();
    $('#edit_formLink, #edit_formPopup').hide();
    if (value === 'link') {
      $('#edit_formLink').show();
    } else if (value === 'popup') {
      $('#edit_formPopup').show();
