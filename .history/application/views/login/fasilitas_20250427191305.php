    ...
    $.ajax({
      ...
      success: function(data) {
        if (data) {
          ...
          $('#edit_formLink, #edit_formPopup').addClass('d-none'); // SEMUA DITUTUP DULU

          if (data.tipe_aksi === 'link') {
            $('#edit_formLink').removeClass('d-none');
            $('#edit_link').val(data.link ?? ''); // Set link kalau ada
          } else if (data.tipe_aksi === 'popup') {
            $('#edit_formPopup').removeClass('d-none');
            $('#edit_deskripsi').val(data.deskripsi ?? ''); // Set deskripsi kalau ada
