...
document.getElementById('tipeAksi').addEventListener('change', function() {
 ...
 $(document).ready(function() {
  ...
  // Create a container that preserves original styles
  var $container = $('<span class="select2-option-container"></span>');
  $container.html('<i class="fas ' + option.id + '"></i> ' + option.text);
  return $container;
}
});
