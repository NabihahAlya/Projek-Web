        ...
        <?php if (!empty($fas['foto'])): ?>
          <div class="carousel-container">
            ...
            <div class="carousel-slide" id="carouselSlide<?= $fas['id_fasilitas'] ?>">
              ...
              <?php endforeach; ?> -->
              <img src="<?= base_url('assets/img/upload/Deluxe.jpg') ?>" alt="<?= $fas['nama'] ?>" />
              <img src="<?= base_url('assets/img/upload/deluxe_room.jpeg') ?>" alt="<?= $fas['nama'] ?>" />
            </div>
  ...
  <div class="box-pop-up">
    ...
    <div class="carousel-container">
      ...
      <div class="carousel-slide" id="carouselSlide1">
        <img src="<?=base_url('assets/img/deluxe room.jpg')?>" alt="Foto 1" />
        <img src="<?=base_url('assets/img/executive room (3).jpg')?>" alt="Foto 2" />
        <img src="<?=base_url('assets/img/family room (1).jpg')?>" alt="Foto 3" />
      </div>
  ...
  <div class="box-pop-up">
    ...
    <div class="carousel-container">
      ...
      <div class="carousel-slide" id="carouselSlide2">
        <img src="<?=base_url('assets/img/bm.jpeg')?>" alt="Foto 1" />
        <img src="<?=base_url('assets/img/ts.jpeg')?>" alt="Foto 2" />
        <img src="<?=base_url('assets/img/ijen (1).jpeg')?>" alt="Foto 3" />
      </div>
