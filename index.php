<?php require_once("header-beranda.php") ?>
...
<section class="section-kamar">
  ...
  <div class="container my-5">
    <div class="card-carousel">
      ...
      <div class="card shadow bg-body rounded" id="card1">
        <div id="imageCarousel1" class="carousel slide image-carousel" data-bs-ride="carousel" data-card-index="0">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="assets/img/deluxe room.jpeg" class="d-block w-100" alt="Deluxe Room Image 1" />
            </div>
            <div class="carousel-item">
              <img src="assets/img/deluxe room.jpg" class="d-block w-100" alt="Deluxe Room Image 2" />
            </div>
          </div>
        ...
        <div class="card-body d-flex justify-content-between">
          ...
          <a href="#" class="btn custom-btn">Pesan Sekarang</a>
        </div>
      </div>
      ...
      <div class="card shadow bg-body rounded" id="card2">
        <div id="imageCarousel2" class="carousel slide image-carousel" data-bs-ride="carousel" data-card-index="1">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="assets/img/executive room.jpg" class="d-block w-100" alt="Executive Room Image 1" />
            </div>
            <div class="carousel-item">
              <img src="assets/img/executive room (1).jpg" class="d-block w-100" alt="Executive Room Image 2" />
            </div>
            <div class="carousel-item">
              <img src="assets/img/executive room (2).jpg" class="d-block w-100" alt="Executive Room Image 3" />
            </div>
          </div>
      ...
      <div class="card shadow bg-body rounded" id="card3">
        <div id="imageCarousel3" class="carousel slide image-carousel" data-bs-ride="carousel" data-card-index="2">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="assets/img/family room.jpg" class="d-block w-100" alt="Family Room Image 1" />
            </div>
            <div class="carousel-item">
              <img src="assets/img/family room (1).jpg" class="d-block w-100" alt="Family Room Image 2" />
            </div>
            <div class="carousel-item">
              <img src="assets/img/family room (2).jpg" class="d-block w-100" alt="Family Room Image 3" />
            </div>
          </div>
    ...
    <div class="text-center mt-4">
      <a href="kamar.php" class="btn custom-btn">Lihat Semua Kamar</a>
    </div>
  </div>
</section>
...
<section id="fasilitas">
  ...
  <div class="daftar-layanan">
    ...
    <a href="javascript:void(0)" class="layanan-item" onclick="openPopup('wisata')">
...
<div class="pop-up" id="popup">
  <div class="box-pop-up">
    <i class="fas fa-times close-icon" onclick="closePopup('popup')"></i>

    <div class="carousel-container">
      <button class="carousel-btn prev" onclick="prevSlide('carouselSlide1')">
        <i class="fas fa-chevron-left"></i>
      </button>
      <div class="carousel-slide" id="carouselSlide1">
        <img src="assets/img/deluxe room.jpg" alt="Foto 1" />
        <img src="assets/img/executive room (3).jpg" alt="Foto 2" />
        <img src="assets/img/family room (1).jpg" alt="Foto 3" />
      </div>
      <button class="carousel-btn next" onclick="nextSlide('carouselSlide1')">
...
<div class="pop-up" id="wisata">
  <div class="box-pop-up">
    <i class="fas fa-times close-icon" onclick="closePopup('wisata')"></i>

    <div class="carousel-container">
      <button class="carousel-btn prev" onclick="prevSlide('carouselSlide2')">
        <i class="fas fa-chevron-left"></i>
      </button>
      <div class="carousel-slide" id="carouselSlide2">
        <img src="assets/img/bm.jpeg" alt="Foto 1" />
        <img src="assets/img/ts.jpeg" alt="Foto 2" />
        <img src="assets/img/ijen (1).jpeg" alt="Foto 3" />
      </div>
      <button class="carousel-btn next" onclick="nextSlide('carouselSlide2')">
        <i class="fas fa-chevron-right"></i>
      </button>
    </div>
    ...
    <div class="popup-detail">
      <h3>Wisata</h3>
      <p>Jelajahi keindahan kota dengan berbagai pilihan wisata menarik yang kami tawarkan, menjadikan perjalanan Anda lebih berkesan.</p>
    </div>
  </div>
</div>
