    ...
    <main class="content mt-5">
      <div class="card mt-5">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <a href="#" class="btn btn-sm btn-primary">+ Tambah Fasilitas</a>
        </div>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr>
                ...
                <td>Kolam Renang</td>
                <td>Popup</td>
                <td><i class="fa fa-swimmer"></i> fa-swimmer</td>
                <td>
              ...
              <tr>
                ...
                <td>Spa</td>
                <td>Popup</td>
                <td><i class="fa fa-spa"></i> fa-spa</td>
                <td>
                  <a href="#" class="btn btn-sm btn-warning">Edit</a>
                  <a href="#" class="btn btn-sm btn-danger">Hapus</a>
                </td>
              ...
              <tr>
                ...
                <td>Lokasi</td>
                <td>Link</td>
                <td><i class="fa fa-map-marker-alt"></i> fa-map-marker-alt</td>
                <td>
                  <a href="#" class="btn btn-sm btn-warning">Edit</a>
                  <a href="#" class="btn btn-sm btn-danger">Hapus</a>
                </td>
