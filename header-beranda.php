...
<html lang="en">
  ...
  <body>
    <header>
      <div class="header">
        <img src="pic/logo_wt_name.png" alt="logo" />
      ...
      <div class="header-img">
        <img src="pic/kamarhelios.jpeg" alt="Helios" />
        <div class="hero-text">
    ...
    <ul>
        ...
        <li class="navi">
          <a href="kritik-saran.php"><i class="fa-solid fa-tty"></i>Kritik & Saran</a>
        </li>
        <li class="navi">
